...
// TODO: ROUTE 2 - Create a new app.get route for the form to create or update new custom object
// data. Send this data along in the next route.
...
app.post("/update-cobj", async (req, res) => {
  const createCustomObjectUrl = `https://api.hubapi.com/crm/v3/objects/${CUSTOM_OBJECT_TYPE_ID}`;
  ...
  try {
    ...
    res.status(500).send("Error creating custom object record in HubSpot.");
  }
});
